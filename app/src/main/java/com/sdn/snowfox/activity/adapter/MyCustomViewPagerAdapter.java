 ...
 */
public class MyCustomViewPagerAdapter extends FragmentPagerAdapter {
    List<BaseFragment> list;

    public MyCustomViewPagerAdapter(FragmentManager fragmentManager, List<BaseFragment> mList) {
